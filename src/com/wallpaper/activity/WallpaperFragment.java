...
public class WallpaperFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (ab != null) {
            ...
            /*
             * final String title = super.getResources().getString(R.string.
             * config_full_screen_wallpaper_title); if (title == null ||
             * title.length() <= 0) { ab.setTitle(mNode.name); } else {
             * ab.setTitle(title); }
             */
        }
    ...
    public void exportImage() {
        ...
        try {
            ...
            final File dir = new File(Environment.getExternalStorageDirectory(), super
                    .getResources().getString(R.string.config_external_storage_folder));
            ...
            // super.getActivity().sendBroadcast(new
            // Intent(Intent.ACTION_MEDIA_MOUNTED, Uri.parse("file://" +
            // dir.toString())));
            Toast.makeText(getActivity(), "Wallpaper Saved To, " + img.toString() + "!",
